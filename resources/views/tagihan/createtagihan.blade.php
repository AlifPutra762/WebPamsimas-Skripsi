                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="jumlah" name="jumlah" class="form-control"
                                            value="{{ old('jumlah') }}" disabled readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label for="tarif" class="form-label">Tarif</label>
                                        <input type="text" class="form-control"
                                            value="Rp {{ number_format($tarif->harga, 0, ',', '.') }} / m³" readonly>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="Rp {{ number_format($abonemen->harga, 0, ',', '.') }}" readonly>
                                        <input type="hidden" id="abonemen" name="abonemen"
                            ...
                            fetch(`/api/data-terakhir/${p.id}`)
                                ...
                                .then(data => {
                                    document.getElementById('awal').value = data
                                        .meter_akhir || 0;
                                    document.getElementById('awal').dispatchEvent(
                                        new Event('input'));

                                    // Set bulan dan tahun otomatis
                                    if (data.bulan && data.tahun) {
                                        const bulanSelect = document.getElementById(
                                            'bulan');
                                        const tahunInput = document.getElementById(
                                            'tahun');

                                        [...bulanSelect.options].forEach(option => {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function hitung() {
                ...
                const ab = parseInt(abonemen.value) || 0;
